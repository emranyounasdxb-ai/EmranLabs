  ...
  return (
    <section className="space-y-5" aria-labelledby="journey-title">
      <PortfolioSectionHeading
        ...
        title="Capability evolution without fabricated employment history"
        titleId="journey-title"
        description={`${portfolioIdentity.brand} presents a truthful professional direction for an ${portfolioIdentity.role}, focused on scalable, secure, professional, and future-ready digital products.`}
      />
      <div className="rounded-[var(--radius-panel)] border border-[var(--glass-border)] bg-white/[0.04] p-4">
        ...
        <p className="mt-3 text-sm leading-6 text-[var(--text-secondary)]">
          The sequence below is a capability and product-building narrative. It
          is not a dated employment chronology and does not include invented
